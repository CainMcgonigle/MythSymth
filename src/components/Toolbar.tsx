  ...
  const quickCreateOptions = [
    {
      ...
      hoverClasses:
        "hover:bg-blue-700/20 hover:text-blue-400 focus:ring-blue-400",
    },
    {
    ...
    },
    {
      ...
      baseClasses: "text-gray-400",
      hoverClasses:
        "hover:bg-orange-700/20 hover:text-orange-400 focus:ring-orange-400",
    },
    {
      ...
      baseClasses: "text-gray-400",
      hoverClasses:
        "hover:bg-emerald-700/20 hover:text-emerald-400 focus:ring-emerald-400",
    },
    {
      ...
      baseClasses: "text-gray-400",
      hoverClasses:
        "hover:bg-purple-700/20 hover:text-purple-400 focus:ring-purple-400",
    },
  ];
