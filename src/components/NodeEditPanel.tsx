...
export const NodeEditPanel: React.FC<NodeEditPanelProps> = ({
  ...
  useEffect(() => {
    if (node) {
      const changed =
        ...
        formData.connectionDirection !==
          (node.data.connectionDirection || "all");
  ...
  const handleUpdate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.description !== (node.data.description || ""))
          ...
          <div className="p-5 flex-1 overflow-y-auto">
            <form onSubmit={handleUpdate}>
              ...
              <div className="bg-gray-900 p-4 rounded-lg mb-5">
                ...
                <div className="text-xs text-gray-400 space-y-1">
                  ...
                  <div>
                    <strong>Position:</strong> ({Math.round(node.position.x)},{" "}
            ...
            <div className="mt-8 p-4 bg-red-950/20 border border-red-900 rounded-lg">
              ...
              <p className="m-0 mb-3 text-xs text-red-200 leading-tight">
                Deleting this node will permanently remove it from your world.
                This action cannot be undone.
              </p>
              <button
